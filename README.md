...
| 时间段 | 场景 | 内容 |
| --- | --- | --- |
| 00:00–00:07 | 开场 | 大屏角色台词（粉色主题）+ 左右旋转樱花 → 项目名与图标 |
| 00:07–00:25 | Live2D 主角 | 项目 Live2D 模型（兔绒）实时驱动动画 + 摄像机运镜，模型居右，左侧功能演示窗口（聊天 / 待办 / 天气 / 日记） |
| 00:25–00:35 | 智能语音 | 语音识别、语音合成、表情动作自动生成 |
| 00:35–00:47 | 多场景 / 助手空间 | 问候、吐槽、祝福、陪伴；助手空间截图 |
| 00:47–00:57 | 桌面小窝 | 实机录像：待办列表 + 天气查询 + 小组件 |
| 00:57–01:03 | 性能 | 低占用模式 |
| 01:03–01:10 | 更多玩法 | 实机录像：日记功能 + 主页 / 日志 / 服务状态 |
| 01:10–01:26 | 安装流程 | 下载 → 解压 → 打开 → 打招呼 |
| 01:26–01:40 | 结尾 | CTA + GitHub 链接 + 致谢 |

> 注：v3 起去掉了花瓣 / 爱心飘落动效；开屏改为台词 + 旋转樱花 + Logo；并集成了项目同款 Live2D 模型。
